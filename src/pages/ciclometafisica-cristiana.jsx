...
const CicloMetafisicaCristiana = () => {
    return (
        <>
            ...
            <h1 className="section__title">CICLO METAFÍSICA CRISTIANA</h1>
                ...
                <Link to="/ciclometafisica-cristiana-libros" className='section__link'>Ver todos los libros del ciclo</Link>
...
export default CicloMetafisicaCristiana;